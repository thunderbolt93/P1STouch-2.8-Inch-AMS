...
lv_obj_t *ui_homeComponent_create(lv_obj_t *comp_parent)
{
    ...
    lv_obj_set_style_text_font(cui_mainScreenTimeLeft, &lv_font_montserrat_16, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(cui_mainScreenLayer, &lv_font_montserrat_16, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(cui_mainScreenNozzleTempValue, &lv_font_montserrat_16, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(cui_mainScreenBedTempValue, &lv_font_montserrat_16, LV_PART_MAIN | LV_STATE_DEFAULT);
